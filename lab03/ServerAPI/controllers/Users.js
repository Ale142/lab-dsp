...
module.exports.getActiveTask = function getActiveTask(req, res, next) {
  Users.getActiveTask(req.params.userId)
    .then(function (response) {
      if (!response) {
        utils.writeJson(res, response, 404)
      } else {
...
module.exports.setActiveTask = function setActiveTask(req, res, next) {
  Users.setActiveTask(req.params.userId, req.params.taskId)
    .then(function (response) {
      if (!response) {
        utils.writeJson(req, response, 404)
      } else {
        utils.writeJson(res, response)
      }
    })
