...
app.get("/api/users/:userId/selection/", passport.authenticate("jwt", { session: false }), userController.getActiveTask);
app.put("/api/users/:userId/selection/:taskId/", passport.authenticate("jwt", { session: false }), userController.setActiveTask);
